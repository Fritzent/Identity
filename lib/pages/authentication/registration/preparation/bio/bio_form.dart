...
import 'package:identity/pages/authentication/registration/preparation/bio/register_bio_form_bloc.dart';
...
import 'package:identity/widgets/custom_multiple_text_fields/custom_multiple_text_field_form.dart';
...
class _BioFormState extends State<BioForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<RegisterBioFormBloc, RegisterBioFormState>(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                        ...
                                        externalErrorText: state.fieldErrorComponent
                                            ...
                                            ? state.fieldErrorComponent.firstWhere(
                                                    (error) => error.containsKey(
                                                        AppLocalizations.of(context)!.professionalTitle))[
                                                AppLocalizations.of(context)!
                                                    .professionalTitle]!
                                            : '',
                                      ),
                                      ...
                                      CustomMultipleTextFieldForm(
                                        numberOfGeneratedFields: 3,
                                        parentTitleSection:
                                            AppLocalizations.of(context)!
                                                .experienceText,
                                        listOfTextFieldLabels: [
                                          AppLocalizations.of(context)!
                                              .currentLastJobTitle,
                                          AppLocalizations.of(context)!
                                              .lengthOfWorkExperienceTitle,
                                          AppLocalizations.of(context)!
                                              .jobDescribeTextTitle,
                                        ],
                                        listOfTextFieldHints: [
                                          AppLocalizations.of(context)!
                                        ...
                                        listofExternalErrorMessages: [
                                          state.fieldErrorComponent.any(
                                                  (error) => error.containsKey(
                                                      AppLocalizations.of(context)!
                                                          .currentLastJobTitle))
                                              ? state.fieldErrorComponent
                                                  ...
                                                  AppLocalizations.of(context)!
                                                      .currentLastJobTitle]!
                                              : '',
                                          state.fieldErrorComponent.any((error) =>
                                                  error.containsKey(AppLocalizations.of(context)!
                                                      .lengthOfWorkExperienceTitle))
                                              ? state.fieldErrorComponent.firstWhere(
                                                      (error) => error.containsKey(
                                                          AppLocalizations.of(context)!
                                          ...
                                          state.fieldErrorComponent.any(
                                              ...
                                              ? state.fieldErrorComponent
                                                      .firstWhere((error) =>
                                                          error.containsKey(
                                                              AppLocalizations.of(context)!.jobDescribeTextTitle))[
                                                  AppLocalizations.of(context)!
                                                      .jobDescribeTextTitle]!
                                              : '',
                                        ],
