...
class _CvFormState extends State<CvForm> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => CvUploadBloc(),
      child: BlocBuilder<CvUploadBloc, CvUploadState>(
        builder: (context, state) {
          var bloc = context.read<CvUploadBloc>();
          return BlocListener<CvUploadBloc, CvUploadState>(
            listener: (context, state) {
              if (!state.isLoading && state.isRegisterCVDone) {
